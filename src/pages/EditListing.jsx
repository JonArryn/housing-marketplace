...
function EditListing() {
  ...
  useEffect(() => {
    if (listing && listing.userRef !== auth.currentUser.uid) {
      navigate("/");
      toast.error("You are not the owner of the listing you tried to edit");
    }
  }, []);
  ...
  useEffect(() => {
    ...
    const fetchListing = async () => {
      ...
      if (docSnap.exists()) {
        ...
        navigate("/");
        toast.error("Listing you tried to edit does not exist");
      }
    };
    fetchListing();
  ...
  const onSubmit = async (event) => {
    ...
    if (geolocationEnabled) {
      ...
      if (location === undefined || location.includes("undefined")) {
        ...
        toast.error(
          "Could not verify address with Google Maps service, please check the address and re-submit"
        );
        return;
      }
    } else {
